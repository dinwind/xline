...
const PRIMITIVES: PrimitiveConfig[] = [
	{
		...
		description: (
			<>
				Reusable instruction sets that Axline loads on demand for specific tasks, without staying in context for unrelated
	...
	},
	{
		...
		description: (
			<>
				Connect Axline to external APIs, local tools, and hosted services through{" "}
